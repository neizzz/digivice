...
const en = {
  ...
  "setup.nameWidth": "name width: {width}/{maxWidth}px",
  ...
  "settings.resetConfirmPlaceholder": "confirm",
  ...
  "offlineAd.message":
    "We're connecting to the ad network. You'll return to the game automatically.",
  ...
  "flappy.restartInstruction": "Press SPACE to restart",
...
const ko: TranslationDictionary = {
  ...
  "setup.nameWidth": "이름 폭: {width}/{maxWidth}px",
  ...
  "flappy.restartInstruction": "SPACE를 눌러 다시 시작",
  "timeOfDay.day": "낮",
...
const ja: TranslationDictionary = {
  ...
  "setup.nameWidth": "名前幅: {width}/{maxWidth}px",
  ...
  "flappy.nearMissGood": "Good!",
  "flappy.nearMissGreat": "Great!",
  "flappy.restartInstruction": "SPACEで再スタート",
  "timeOfDay.day": "昼",
...
const zhTW: TranslationDictionary = {
  ...
  "setup.nameWidth": "名稱寬度：{width}/{maxWidth}px",
  "setup.error.emptyName": "請輸入名稱。",
  "setup.error.minLength": "名稱至少需要 {minLength} 個字元。",
  "setup.error.maxWidth": "名稱必須符合遊戲標籤的 {maxWidth}px 寬度。",
  "setup.start": "開始",
  "settings.title": "設定",
  ...
  "flappy.restartInstruction": "按 SPACE 重新開始",
  "timeOfDay.day": "白天",
...
const hi: TranslationDictionary = {
  ...
  "setup.nameWidth": "नाम चौड़ाई: {width}/{maxWidth}px",
  ...
  "flappy.restartInstruction": "रीस्टार्ट के लिए SPACE दबाएँ",
  "timeOfDay.day": "दिन",
...
const th: TranslationDictionary = {
  ...
  "setup.nameWidth": "ความกว้างชื่อ: {width}/{maxWidth}px",
  ...
  "flappy.restartInstruction": "กด SPACE เพื่อเริ่มใหม่",
...
const vi: TranslationDictionary = {
  ...
  "setup.nameWidth": "độ rộng tên: {width}/{maxWidth}px",
  ...
  "flappy.restartInstruction": "Nhấn SPACE để chơi lại",
  "timeOfDay.day": "Ngày",
...
const ptBR: TranslationDictionary = {
  ...
  "setup.nameWidth": "largura do nome: {width}/{maxWidth}px",
  ...
  "flappy.restartInstruction": "Pressione SPACE para reiniciar",
  "timeOfDay.day": "Dia",
