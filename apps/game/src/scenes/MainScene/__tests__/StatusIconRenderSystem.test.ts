...
const CHARACTER_TOP_RIGHT_SINGLE_ICON_X = 104;
const CHARACTER_TOP_RIGHT_SINGLE_ICON_X_WALKING = 105;
const RIGHT_CLAMPED_SINGLE_ICON_X = 307;
const CHARACTER_TOP_RIGHT_DOUBLE_ICON_LEFT_X = 90.5;
const CHARACTER_TOP_RIGHT_DOUBLE_ICON_RIGHT_X = 117.5;
