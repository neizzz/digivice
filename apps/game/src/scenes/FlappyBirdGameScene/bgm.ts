...
const FLAPPY_BIRD_VOLUME_INCREASE_MULTIPLIER = 1.3;
const FLAPPY_BIRD_BGM_MASTER_GAIN =
  0.066 *
  FLAPPY_BIRD_AUDIO_VOLUME_MULTIPLIER *
  FLAPPY_BIRD_VOLUME_INCREASE_MULTIPLIER;
...
const FLAPPY_BIRD_PIPE_PASS_CUE_GAIN_MULTIPLIER = 1.3;
...
export class FlappyBirdBgmController {
  ...
  public playPipePassCue(hasNearMissBonus = false): void {
    ...
    this.scheduleEffectVoice({
      ...
      peakGain:
        (hasNearMissBonus ? 0.192 : 0.144) *
        FLAPPY_BIRD_PIPE_PASS_CUE_GAIN_MULTIPLIER,
    });
  }
