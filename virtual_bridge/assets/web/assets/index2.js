...
function requireReactJsxDevRuntime_development() {
  ...
  (function() {
    ...
    reactJsxDevRuntime_development.jsxDEV = function(type, config, maybeKey, isStaticChildren, source, self2) {
...
const buildLogoText = "".trim();
function TopLeftBuildLogoText() {
  if (!buildLogoText) {
    return null;
  }
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "build-logo-text", children: buildLogoText }, void 0, false, {
    fileName: "/Users/neiz/digivice/apps/client/src/components/TopLeftBuildLogoText.tsx",
    lineNumber: 10,
    columnNumber: 10
  }, this);
}
