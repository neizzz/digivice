    ...
    fun publish(
        ...
        prefs.edit().apply {
            if (snapshotJson.isNullOrEmpty()) {
                ...
                remove(HomeWidgetConstants.REFRESH_BACKGROUND_ENQUEUE_STATUS_KEY)
                remove(HomeWidgetConstants.REFRESH_BACKGROUND_ENQUEUE_ERROR_KEY)
                remove(HomeWidgetConstants.REFRESH_BACKGROUND_STARTED_AT_MS_KEY)
                remove(HomeWidgetConstants.REFRESH_BACKGROUND_COMPLETED_AT_MS_KEY)
                remove(HomeWidgetConstants.REFRESH_BACKGROUND_STATUS_KEY)
                remove(HomeWidgetConstants.REFRESH_BACKGROUND_ERROR_KEY)
